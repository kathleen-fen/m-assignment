<template>
    <div class="graph">
        <h4 id="test">Graph Of The Work Machine</h4>
        <ul class="yAxis">
            <li>50000</li>
            <li>45000</li>
            <li>40000</li>
            ...
            <dl id="csschart">
                <dd v-for="el in hours" :key="el.name" :class="el.perc"><span><b>{{ el.value }}</b></span></dd>
        </dl>
        <ul class="xAxis">
			<li v-for="h in hoursKeys" :key="h.index">{{ h }}</li>
        </ul>
    </div>
</template>
<script>
...
dl#csschart{
	background:url(./../assets/images/bg_chart.gif) no-repeat 0 0;
	height:360px;
	padding-left:11px;
	float:left;
	} 
...
dl#csschart span{
	height:50%;
	background:url(./../assets/images/bar.png) repeat-y;
} 
